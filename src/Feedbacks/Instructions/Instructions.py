...
class Instructions(MainloopFeedback):
    '''
        ...
        This class opens up a html file or and url in browser and closes it after predetermined time or after a key press. 
        ...
        The self.browser variable should be the command used to start the browser from a command line. 
        e.g. to start chrome:
    ...
    def init(self):
        ...
        # The browser can either be closed after a certain amount of time or with a keypress
