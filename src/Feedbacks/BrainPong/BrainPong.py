...
################################################################################
    ...
    def trial_tick(self):
        ...
        stepX = stepY / 2 * self.oneOrminusone
        ...
        if self.showCounter:
            ...
            center = (self.wallSize[0]+self.playWidth*self.x_transl, self.size/20)
        ...
        if self.control == "absolute":
            ...
            #class_out = 1
            #class_out = (random.randint(0,1)-0.5)*2
            #self.it += 1
